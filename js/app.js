...
function init() {
    ...
    if (empDept) empDept.addEventListener('change', renderEmployees);
    var empStatus = document.getElementById('empStatusFilter');
    if (empStatus) empStatus.addEventListener('change', renderEmployees);
    ...
    if (invCat) invCat.addEventListener('change', renderInventory);
    var invSort = document.getElementById('invSort');
    if (invSort) invSort.addEventListener('change', renderInventory);
    ...
    if (delDateFilter) delDateFilter.addEventListener('change', renderDeliveries);
    var delStatusFilter = document.getElementById('delStatusFilter');
    if (delStatusFilter) delStatusFilter.addEventListener('change', renderDeliveries);
    ...
    if (applyReport) applyReport.addEventListener('click', renderReports);
